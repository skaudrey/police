...
public class SheriffPoliceMapActivity extends Activity  
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_sheriffpolicemap);	
       ...
       // 初始化搜索模块，注册事件监听
        ...
        System.out.println("单个警员————————————");
        System.out.println("起点"+myapp.s_pcPath.getSPt());
        System.out.println("终点"+myapp.s_pcPath.getEPt());
        System.out.println("单个警员起点"+myapp.s_pcPath.getPathStr());
        
        search(myapp.s_pcPath.getSPt(), 
				myapp.s_pcPath.getEPt(), 
						mSearch);
        
        findViewById(R.id.spm_bt_details).setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				//根据警员号查案件
	        	
	        	Intent intent=new Intent(SheriffPoliceMapActivity.this, SheriffPoliceInfoActivity.class);
    ...
    public void onGetDrivingRouteResult(DrivingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(SheriffPoliceMapActivity.this,
