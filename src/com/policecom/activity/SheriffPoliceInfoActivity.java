...
public class SheriffPoliceInfoActivity extends Activity{
	...
	private Handler endhandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
        	if(msg.what==200){
        		Intent intent=new Intent(SheriffPoliceInfoActivity.this, PoliceCaseMapActivity.class);
				startActivity(intent);
				finish();
            }else{
            	Toast.makeText(SheriffPoliceInfoActivity.this, "下载失败，请重试一次！", Toast.LENGTH_SHORT).show();
            }
    ...
    private Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
        	if(msg.what==200){
        		...
        		System.out.println("警长-----------得到案件联网成功！");
    ...
    private Handler imagehandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
        	if(msg.what==200){
            	...
            	Toast.makeText(SheriffPoliceInfoActivity.this, "下载图片失败，请重试一次！", Toast.LENGTH_SHORT).show();
            }
            super.handleMessage(msg); 
        }
    };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SheriffToServer.GetCaseByPoliceNum(myapp.get_URL(), myapp.S_PoliceNum, handler);
        ...
        imageListView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view,
			    ...
			    Intent intent = new Intent();  
			     //设置传递方向   
			    intent.setClass(SheriffPoliceInfoActivity.this,ImageActivity.class);   
			    //绑定数据   
