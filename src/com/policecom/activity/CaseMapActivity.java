...
public class CaseMapActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				myapp.U_INFO.setCasePt(pt.latitude+"-"+
							pt.longitude);
				myapp.U_INFO.setPtCity(ptCity);
				myapp.U_INFO.setPtDis(ptDis);
				myapp.U_INFO.setPtStreet(ptStreet);
				System.out.println(myapp.U_INFO.getPtStreet());
				Intent intent=new Intent(CaseMapActivity.this,CaseActivity.class);
			...
			public void onMapClick(LatLng point){
				...
				view.btSet.setOnClickListener(
						new OnClickListener() {
							public void onClick(View v) {
								pt=pickedP;
								System.out.println("picked Point:"+
								pt);
	...
	public void onGetGeoCodeResult(GeoCodeResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(CaseMapActivity.this, 
					"抱歉，编码未能找到结果",
	...
	public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
		if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
			Toast.makeText(CaseMapActivity.this, "抱歉，反编码未能找到结果",
					Toast.LENGTH_LONG).show();
			return;
			}
